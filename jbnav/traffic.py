...
class Traffic:
    def __init__(self, experiment, client, traffic_size, tm_port):
        self.experiment = experiment
        self.num_vehicles = traffic_size[0]
        self.num_walkers = traffic_size[1]
        self.client = client
        ...
        if self.num_vehicles < number_of_spawn_points:
            random.shuffle(spawn_points)
        elif self.num_vehicles > number_of_spawn_points:
            msg = "requested %d vehicles, but could only find %d spawn points"
            logging.warning(msg, self.num_vehicles, number_of_spawn_points)
            self.num_vehicles = number_of_spawn_points
        ...
        print(
            ...
            % (len(self.vehicles_list), len(walkers_list))
        )
